...
const BackendStatusChecker = (props: { url: string }) => {
  ...
  return (
    ...
    className="fixed bg-gray-100 border flex z-30 border-gray-300 bottom-4 md:bottom-10 md:right-10 rounded-xl mx-4 px-6 py-4 shadow-2xl">
      {isBackendUp ? (
        ...
        <p className="text-red-600 font-semibold align-middle flex gap-2">
          <Spinner />
          <span className="my-auto">Checking if backend is up...</span>
        </p>
      )}
    </motion.div>
  );
