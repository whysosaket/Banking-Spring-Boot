        ...
        className="bg-gray-900 bg-opacity-0 flex items-center justify-center p-4 md:p-0">
          <div className="bg-gray-100 bg-opacity-40 text-gray-500 shadow-xl w-full overflow-hidden rounded-3xl my-16 md:my-0 md:rounded-none">
            <div className="md:flex w-full">
              ...
              initial={{x: 500,rotateY: 180, opacity: 0}} animate={{x: 0,rotateY: 0, opacity: 1}}

              transition={{duration: 0.6}} className="hidden md:block w-1/2 bg-rose-100 bg-opacity-50 py-10 px-10">
              ...
              <motion.div initial={{x: -500, opacity: 0}} animate={{x: 0, opacity: 1}} transition={{duration: 0.6}} className="w-full md:w-1/2 py-10 px-5 md:px-10">
                ...
                <div>
                  ...
                  <div className="flex -mx-3">
                    <div className="w-full px-3 mb-5">
                      <button onClick={handleLogin} className="block w-full max-w-xs mx-auto bg-rose-500 hover:bg-rose-700 focus:bg-rose-700 text-white rounded-lg px-3 py-3 font-semibold">
                        LOGIN
                      </button>
                    </div>
                  </div>
                  <h1 className="text-center text-sm">Don't have an account? <Link to="/register" className="text-rose-600">Register</Link></h1>
                </div>
              </motion.div>
            </div>
          </div>
